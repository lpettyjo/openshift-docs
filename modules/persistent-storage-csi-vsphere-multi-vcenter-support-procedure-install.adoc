...
* Specify multiple vSphere clusters during installation. For information, see _Installation configuration parameters for vSphere_ under _Additional resources_.
