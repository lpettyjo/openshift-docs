...
[role="_abstract"]
To remove the AWS Elastic File System (EFS) Container Storage Interface (CSI) Driver Operator and free cluster resources, uninstall the operator after stopping applications and deleting persistent volumes (PVs).
