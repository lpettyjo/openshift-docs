...
.Next steps
You can mount secrets from an external secrets store to a CSI volume. For information about mounting secrets from an external secrets store, see _Providing sensitive data to pods by using an external secrets store_ under _Additional resources_.
