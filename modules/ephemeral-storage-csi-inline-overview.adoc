...
[IMPORTANT]
====
The Shared Resource CSI Driver feature is now generally available in {builds-v2title} 1.1. This feature is now removed in {product-title} 4.18 and later. To use this feature, ensure that you are using {builds-v2title} 1.1 or later. For information about {builds-v2title} 1.1, see _{builds-v2title} 1.1_ under _Additional resources_.
====
