...
[role="_abstract"]
Create a new persistent volume claim (PVC) that provisions from an existing PVC clone. The new volume automatically populates with a copy of the source PVC's data and must be created in the same namespace as the source. 
