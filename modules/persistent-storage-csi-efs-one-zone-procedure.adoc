...
[role="_abstract"]
To use AWS Elastic File System (EFS) One Zone file systems with Security Token Service (STS) authentication, configure separate credential requests and role ARNs for both the controller and driver nodes.
