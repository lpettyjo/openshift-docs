...
If you have problems setting up static PVs, see _AWS EFS troubleshooting_.
...
* `spec.csi.encryptInTransit`: If desired, you can disable encryption in transit. Encryption is enabled by default.
