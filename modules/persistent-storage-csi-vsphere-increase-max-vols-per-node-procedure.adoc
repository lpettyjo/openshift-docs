...
* In vCenter, ensure that the parameter `pvscsiCtrlr256DiskSupportEnabled` is set to 'True'. For information about how to set this parameter, see VMware vSphere vCenter documentation under the _Additional Resource_ section.
