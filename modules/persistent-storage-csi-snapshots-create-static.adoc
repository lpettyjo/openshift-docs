...
* `status.boundVolumeSnapshotContentName`: The pointer to the actual storage content that was created by the controller.

* `status.creationTime`: The time when the snapshot was created. The snapshot contains the volume content that was available at this indicated time.
