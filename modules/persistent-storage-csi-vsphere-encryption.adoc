...
For information about encrypting VMs, see, under _Additional resources_:

* _Requirements for encrypting virtual machines_

* _During installation: Step 7 of Installing RHCOS and starting the {product-title} bootstrap process_

* _Enabling encryption on a vSphere cluster_
