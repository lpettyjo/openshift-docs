...
+
----
openshift_storage_glusterfs_version=v<your_cns_version> <1>
openshift_storage_glusterfs_block_version=v<your_cns_version>
openshift_storage_glusterfs_heketi_version=v<your_cns_version>
----
<1> For '<your_cns_version>', specify the CNS version, such as *3.9* or *3.11.3*.
+
.. Update the image tags from *latest* to '<your_cns_version>', such as *3.9* or *3.11.3*, on the following resources:
+
----
