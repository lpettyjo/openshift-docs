...
[role="_additional-resources"]
.Additional resources
* xref:../../nodes/pods/nodes-pods-secrets-store.adoc#mounting-secrets-external-secrets-store[Providing sensitive data to pods by using an external secrets store]
