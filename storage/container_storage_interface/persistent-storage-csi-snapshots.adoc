...
Familiarity with persistent volumes is suggested. For information about persistent volumes, see _Persistent volumes_ under _Additional resources_.

include::modules/persistent-storage-csi-snapshots-overview.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources
* https://kubernetes-csi.github.io/docs/drivers.html[Kubernetes CSI Developer Documentation_]
